...
- ignore_unavailable
	...
	- POST http://localhost:9200/school*,book_shops/_search?ignore_unavailable=true, 假设book_shops不存在，响应也不会报404错误
- allow_no_indices
...
- 操作类型
	...
	- POST http://localhost:9200/tutorials/chapter/1?op_type=create, 是一种明确操作类型的操作，防止更新已有文档。指明create后，如果已有该index/type/id则报错version conflict
- 指定所需的字段
